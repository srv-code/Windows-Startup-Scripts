...
strDirectory = "C:\Users\" & strUsername & "\AppData\Local\AutoLogger\Logs"
strFile = "\login.log"
...
''''''''' Disabled welcome voice greetings '''''''''
...
str = msgbox("Welcome " & strUsername & "!" & (Chr(10)) _
				& "Login successfully logged" & (Chr(10)) _
				& "Logged on " & strDate & " at " & strTime & (Chr(10)) _
				& "Log file: " & (Chr(10)) & "  " & strDirectory & strFile, vbInformation, "AutoLogger: Welcome wisher")
...
If err.number = vbEmpty then
	...
	If (msgbox("Want to view all " & logEntriesCount & " log entries?", vbYesNo + vbDefaultButton2, "AutoLogger: View log?") = vbYes) Then
